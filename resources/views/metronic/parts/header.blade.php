        ...
        <div class="kt-header__topbar">
            ...
            <div class="kt-header__topbar-item dropdown">
                  <!--  <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="30px,0px" aria-expanded="true">
                    <div id="count-notifications">0</div>
...
<span class="kt-badge kt-badge--dot kt-badge--notify kt-badge--sm kt-badge--brand"></span>
                ...
                <div id="menu-notifications" class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                    <form>
                        ...
                        <!--begin: Head -->
                        <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b pt-0 p-5" style="background-image: url({{asset("assets/$theme")}}/media/misc/bg-1.png);padding:10px !important;">
                            <h3 class="kt-head__title" id="container-new-notifications">
Notifications
                          
                                &nbsp;
                                <a href="#"> <span class="btn btn-danger btn-sm btn-bold btn-font-md">  See all </span></a>
            ...
            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                    ...
                    <span class="kt-header__topbar-username kt-hidden-mobile">{{ auth()->user()->name }}</span>
                        ...
                        <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold picture-profile-span">
                                <img  class="picture-profile w-100" src="{{ (empty(auth()->user()->profile_photo_path))? asset("assets/images/user_default.png") : "/storage/". auth()->user()->profile_photo_path }}"  />   
                ...
                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                    ...
                    <!--begin: Head -->
                    <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url({{asset("assets/$theme")}}/media/misc/bg-1.png)">
                        <div class="kt-user-card__avatar">
                            <img class="kt-hidden" alt="Pic" src="{{asset("assets/$theme")}}/media/users/300_25.jpg" />

                            <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                            <span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success picture-profile-span">
                                    <img  class="picture-profile" src="{{ (empty(auth()->user()->profile_photo_path))? asset("assets/images/user_default.png") : "/storage/". auth()->user()->profile_photo_path }}"  />  
                            </span>
                        </div>
                    ...
                    <div class="kt-notification">
                        ...
                        <span class="btn btn-success btn-sm btn-bold btn-font-md text-capitalize"></span>
                        </div>
                    -->
                    <a href="#"  data-toggle="modal" data-target="#modal_change_password" class="kt-notification__item">
                            <div class="kt-notification__item-icon">
                                <i class="icon-xl fas fa-lock-open kt-font-brand"></i>
                            </div>
