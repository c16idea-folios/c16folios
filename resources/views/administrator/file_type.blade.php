...
@section('title') Informe de tipos de archivo @endsection
...
<div class="modal fade" id="modal_add" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('file_type.admin.store')}}" method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <label for="type" class="form-control-label">Tipo de archivo *</label>
...
<div class="modal fade" id="modal_edit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('file_type.admin.update')}}" method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input style="display:none">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="type_e" class="form-control-label">Tipo de archivo *</label>
...
<!-- end: Modal edit  -->
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('file_type.admin.delete')}}" id="form_delete" method="POST" autocomplete="off">
                                @csrf
                                @method('DELETE')
...
<script src="{{asset("assets")}}/js/page-file-type.js" type="text/javascript"></script>
@endsection
