...
@section('title') Informe denominaciones @endsection
...
<div class="modal fade" id="modal_add" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('denominations.admin.store')}}" method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <label for="denomination" class="form-control-label">Denominación *</label>
                                <input type="tel" name="denomination" class="form-control" id="denomination" value="{{ old('denomination') }}" required>
                            </div>
...
<div class="modal fade" id="modal_edit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('denominations.admin.update')}}" method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input style="display:none">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <label for="orden" class="form-control-label">Orden</label>
                                <input type="text" name="order" class="form-control" id="order-e" value="{{ old('order') }}">
                            </div>
                            <div class="form-group">
                                <label for="acronym" class="form-control-label">Siglas *</label>
                                <input type="text" name="acronym" class="form-control" id="acronym-e" value="{{ old('acronym') }}" required>
                            </div>
                            <div class="form-group">
                                <label for="denomination" class="form-control-label">Denominación *</label>
                                <input type="tel" name="denomination" class="form-control" id="denomination-e" value="{{ old('denomination') }}" required>
                            </div>
...
<!-- end: Modal edit  -->
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('denominations.admin.delete')}}" id="form_delete" method="POST" autocomplete="off">
                                @csrf
                                @method('DELETE')
...
<script src="{{asset("assets")}}/js/page-denominations.js" type="text/javascript"></script>
@endsection
