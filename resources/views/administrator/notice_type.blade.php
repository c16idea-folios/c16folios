...
@section('title') Informe tipo de avisos @endsection
            ...
            <table class="table-bordered table-hover table-data-custom" id="kt_table">
                <thead>
                    <tr>
                        ...
                        <th>Acto</th>
                        <th>Tipo de aviso</th>
                        <th>Días para presentar</th>
                        <th>Observaciones</th>
                        <th>Unicamente extranjeros</th>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <label for="foreigners" class="form-control-label">Unicamente extranjeros *</label>
                                <select name="foreigners" id="foreigners" class="form-control" required>
                                    <option value="yes" {{ old('foreigners') == 'yes' ? 'selected' : '' }}>Sí</option>
                                    <option value="no" {{ old('foreigners') == 'no' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <label for="foreigners_e" class="form-control-label">Unicamente extranjeros *</label>
                                <select name="foreigners" id="foreigners_e" class="form-control" required>
                                    <option value="yes" {{ old('foreigners') == 'yes' ? 'selected' : '' }}>Sí</option>
                                    <option value="no" {{ old('foreigners') == 'no' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
...
<script src="{{asset("assets")}}/js/page-notice-type.js" type="text/javascript"></script>
@endsection