...
@section('title') Modalidad de pago @endsection
...
'Administración','Modalidad de pago'
]) !!}
@endsection
...
<div class="modal fade" id="modal_add" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('payment_method.admin.store')}}" method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <label for="method" class="form-control-label">Modalidad de pago *</label>
                                <input type="text" name="method" class="form-control" id="method" value="{{ old('method') }}" required>
                            </div>
                            <div class="form-group">
                                <label for="acronym" class="form-control-label">Siglas *</label>
                                <input type="text" name="acronym" class="form-control" id="acronym" value="{{ old('acronym') }}" required>
                            </div>
...
<div class="modal fade" id="modal_edit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('payment_method.admin.update')}}" method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input style="display:none">
         ...
         <div class="form-group">
             ...
             <input type="text" name="order" class="form-control" id="order_e" value="{{ old('order') }}">
         </div>
         <div class="form-group">
             <label for="method_e" class="form-control-label">Modalidad de pago *</label>
             <input type="text" name="method" class="form-control" id="method_e" value="{{ old('method') }}" required>
         </div>
         <div class="form-group">
             <label for="acronym_e" class="form-control-label">Siglas *</label>
             <input type="text" name="acronym" class="form-control" id="acronym_e" value="{{ old('acronym') }}" required>
         </div>
...
<!-- end: Modal edit  -->
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('payment_method.admin.delete')}}" id="form_delete" method="POST" autocomplete="off">
                                @csrf
                                @method('DELETE')
...
$("#order,#order-e").ForceNumericOnly();
...
<script src="{{asset("assets")}}/js/page-payment-method.js" type="text/javascript"></script>
@endsection
