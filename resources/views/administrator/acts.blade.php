...
@section('title') Informe de actos @endsection
...
<div class="modal fade" id="modal_add" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('acts.admin.store')}}" method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <label for="act" class="form-control-label">Acto *</label>
                                <input type="text" name="act" class="form-control" id="act" value="{{ old('act') }}" required>
                            </div>
                            <div class="form-group">
                                <label for="extract" class="form-control-label">Estracto *</label>
                                <select name="extract" id="extract" class="form-control" required>
                                    <option value="yes" {{ old('extract') == 'yes' ? 'selected' : '' }}>Sí</option>
                                    <option value="no" {{ old('extract') == 'no' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
...
<div class="modal fade" id="modal_edit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('acts.admin.update')}}" method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input style="display:none">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="act_e" class="form-control-label">Acto *</label>
                                <input type="text" name="act" class="form-control" id="act_e" value="{{ old('act') }}" required>
                            </div>
                            <div class="form-group">
                                <label for="extract_e" class="form-control-label">Estracto *</label>
                                <select name="extract" id="extract_e" class="form-control" required>
                                    <option value="yes" {{ old('extract') == 'yes' ? 'selected' : '' }}>Sí</option>
                                    <option value="no" {{ old('extract') == 'no' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
...
<!-- end: Modal edit  -->
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('acts.admin.delete')}}" id="form_delete" method="POST" autocomplete="off">
                                @csrf
                                @method('DELETE')
...
@section('js_page_vendors')
        ...
        <script src="{{asset("assets/$theme")}}/vendors/general/bootstrap-select/dist/js/bootstrap-select.js" type="text/javascript"></script>
                ...
                <!-- Luego cargar JSZip y FileSaver.js -->
...
<script src="{{asset("assets")}}/js/page-acts.js" type="text/javascript"></script>
@endsection
