...
@section('title') Informe de archivos @endsection
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Registro de archivo</h5>
            ...
            <div class="col-12">
             <form action="{{route('file.admin.store')}}"  method="POST"  enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="from_files_view" value="">
        ...
        <div class="modal-content">
            ...
            <div class="col-12">
             <form action="{{route('file.admin.update')}}"  method="POST"  enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                    <label for="file_e" class="form-control-label">Archivo *</label>
                    <input type="file" name="file_upload" class="form-control" id="file_e" >
                </div>
...
<script src="{{asset("assets")}}/js/page-files.js" type="text/javascript"></script>
@endsection