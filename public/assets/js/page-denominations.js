        ...
        tableMain = $('#kt_table').DataTable({
            ...
            buttons: [
                createExcelExportButton({
                    ...
                    filename: 'Informe denominaciones.xlsx',
...
$("#order-e").val(data.order);
$("#acronym-e").val(data.acronym);
$("#denomination-e").val(data.denomination);
