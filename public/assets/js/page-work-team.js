        ...
        tableMain = $('#kt_table').DataTable({
            ...
            columnDefs: [
                {
                    ...
                    'render': function(data, type, full, meta) {
                        ...
                        return `<div style="color:${data} ; font-weight:bold;">${data}</div>`;
                    }
                },
                {
                    'targets': 0,
            ...
            buttons: [
                createExcelExportButton({
                    ...
                    filename: 'Informe de equipos de trabajo.xlsx',
...
function editElement(data){
    ...
    $("#team_e").val(data.team);
   
    setColorE(data.identifier);
